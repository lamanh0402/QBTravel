...
<table class="container1" >
  ...
  <thead>
    <tr>
      ...
      <th><h1>Giá công bố(VNĐ)</h1></th>
      <th><h1>Giá đặt tại QuangBinh Travel</h1></th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td>Deluxe Twin/Double – GIT</td>
      <td> &emsp;     </td>
      <td>&emsp; </td>
      <td>950.000</td>
    </tr>
    ...
    <tr>
	  ...
	  <h3 style="font-size: 2.6rem;  color: #f78536; text-align: center; padding-top: 30px;">Tiện ích của  <?php echo $row['ten']; ?>   
                ...
                <li>                Dịch vụ giữ hành lý
                </li>
                <li>                Hệ thống báo cháy
                </li>
                <li>                Hồ bơi ngoài trời
                </li>
                <li>                Nhà hàng, Khu ăn uống
                </li> </div>
				<div style="flex: 50%; padding-left:100px;">
                <li>                Phòng họp/Dịch vụ hội nghị               </li>
	  ...
	  <p style="padding-top: 10px;"><a style="font-size: 18px;">Thời gian nhận phòng</a> 14:00</p>
                   <p><a style="font-size: 18px;" >Thời gian trả phòng</a> 11:30</p> 
                    <p><a style="font-size: 18px;"> Khoảng cách di chuyển</a></p>
                    <p>Khách sạn Mường Thanh Luxury Nhật Lệ nằm ngay gần bãi tắm Nhật Lệ, cách sân bay Đồng Hới khoảng 7 km và cách ga Đồng Hới khoảng 6 km.</p>
                    <p>Khoảng cách từ Khách sạn Mường Thanh Luxury Nhật Lệ đến các địa điểm tham quan, du lịch nổi tiếng ở Quảng Bình : <br>
                        – Khoảng cách đến vườn quốc gia Phong Nha Kẻ Bàng: khoảng 50 km. <br>
                        – Khoảng cách đến Vũng Chùa Đảo Yến: khoảng 60 km. <br>
                        – Khoảng cách đến Động Thiên Đường: khoảng 60 km. <br>
                        – Khoảng cách đến Suối Khoáng Bang: khoảng 63 km. <br>
                    </p>
                 ...
                 <p> ✔️ Việc đặt phòng sẽ tùy thuộc vào tình trạng phòng trống của khách sạn.        </p>
                    ...
                    <p><a style="font-size: 18px;">Chính sách cho trẻ em                    </a></p>
                    <p> ✔️ Miễn phí ăn sáng dành cho hai trẻ em dưới 06 tuổi sử dụng chung phòng với bố mẹ và không sử dụng giường phụ (tối đa 02 trẻ/phòng). Trẻ em từ 6 – 11 tuổi sử dụng chung phòng với bố mẹ và không sử dụng giường phụ sẽ phụ thu ăn sáng 70,000 vnd/bữa/trẻ.                    </p>
                    <p> ✔️Trẻ em từ 12 tuổi trở lên được tính như người lớn, nếu ở chung với bố/mẹ tính 280.000 vnd/đêm bao gồm ăn sáng, nếu kê giường phụ tính 350.000 vnd/đêm bao gồm ăn sáng.                    </p>
       </div>
	  </div>
       ...
       <div class="content content-4">
                    <div class="embin">
                        ...
                        <div class="reviews" style="margin-left: 110px;">
                            ...
                            <a style="color: chocolate;">4.5/5</a>
